...
public final class Ethereum {
  ...
  public enum TransactionMode
    ...
    public static final com.google.protobuf.Descriptors.EnumDescriptor
        getDescriptor() {
      return wallet.core.jni.proto.Ethereum.getDescriptor().getEnumTypes().get(0);
    }

    private static final TransactionMode[] VALUES = values();

    public static TransactionMode valueOf(
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 50: {
              ...
              maxInclusionFeePerGas_ = input.readBytes();
              break;
            }
            case 58: {

              maxFeePerGas_ = input.readBytes();
              break;
            }
            case 66: {
              java.lang.String s = input.readStringRequireUtf8();
     ...
     * @return The enum numeric value on the wire for txMode.
     */
    @java.lang.Override public int getTxModeValue() {
      return txMode_;
    }
    /**
     * <pre>
     ...
     * @return The txMode.
     */
    @java.lang.Override public wallet.core.jni.proto.Ethereum.TransactionMode getTxMode() {
      @SuppressWarnings("deprecation")
      wallet.core.jni.proto.Ethereum.TransactionMode result = wallet.core.jni.proto.Ethereum.TransactionMode.valueOf(txMode_);
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (txMode_ != wallet.core.jni.proto.Ethereum.TransactionMode.Legacy.getNumber()) {
        output.writeEnum(3, txMode_);
      }
      ...
      if (!maxInclusionFeePerGas_.isEmpty()) {
        output.writeBytes(6, maxInclusionFeePerGas_);
      }
      if (!maxFeePerGas_.isEmpty()) {
        output.writeBytes(7, maxFeePerGas_);
      }
      if (!getToAddressBytes().isEmpty()) {
        com.google.protobuf.GeneratedMessageV3.writeString(output, 8, toAddress_);
      }
      if (!privateKey_.isEmpty()) {
        output.writeBytes(9, privateKey_);
      }
      if (transaction_ != null) {
        output.writeMessage(10, getTransaction());
      }
      unknownFields.writeTo(output);
    }
    ...
    public int getSerializedSize() {
      ...
      if (!maxInclusionFeePerGas_.isEmpty()) {
        size += com.google.protobuf.CodedOutputStream
          .computeBytesSize(6, maxInclusionFeePerGas_);
      }
      if (!maxFeePerGas_.isEmpty()) {
        size += com.google.protobuf.CodedOutputStream
          .computeBytesSize(7, maxFeePerGas_);
      }
      if (!getToAddressBytes().isEmpty()) {
        size += com.google.protobuf.GeneratedMessageV3.computeStringSize(8, toAddress_);
      }
      if (!privateKey_.isEmpty()) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (transaction_ != null) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(10, getTransaction());
      }
      size += unknownFields.getSerializedSize();
      memoizedSize = size;
      return size;
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (txMode_ != other.txMode_) return false;
      if (!getGasPrice()
          .equals(other.getGasPrice())) return false;
      if (!getGasLimit()
          .equals(other.getGasLimit())) return false;
      if (!getMaxInclusionFeePerGas()
          .equals(other.getMaxInclusionFeePerGas())) return false;
      if (!getMaxFeePerGas()
          .equals(other.getMaxFeePerGas())) return false;
      if (!getToAddress()
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + TX_MODE_FIELD_NUMBER;
      hash = (53 * hash) + txMode_;
      ...
      hash = (37 * hash) + MAX_INCLUSION_FEE_PER_GAS_FIELD_NUMBER;
      hash = (53 * hash) + getMaxInclusionFeePerGas().hashCode();
    ...
    public static final class Builder extends
      ...
      public wallet.core.jni.proto.Ethereum.SigningInput buildPartial() {
        ...
        result.txMode_ = txMode_;
        result.gasPrice_ = gasPrice_;
        result.gasLimit_ = gasLimit_;
        result.maxInclusionFeePerGas_ = maxInclusionFeePerGas_;
      ...
      public Builder mergeFrom(wallet.core.jni.proto.Ethereum.SigningInput other) {
        ...
        if (other.txMode_ != 0) {
          setTxModeValue(other.getTxModeValue());
        }
        ...
        if (other.getMaxInclusionFeePerGas() != com.google.protobuf.ByteString.EMPTY) {
          setMaxInclusionFeePerGas(other.getMaxInclusionFeePerGas());
        }
        if (other.getMaxFeePerGas() != com.google.protobuf.ByteString.EMPTY) {
          setMaxFeePerGas(other.getMaxFeePerGas());
        }
    ...
    throw new NullPointerException();
      ...
      private com.google.protobuf.ByteString maxInclusionFeePerGas_ = com.google.protobuf.ByteString.EMPTY;
      /**
       * <pre>
       * Maxinmum optional inclusion fee (aka tip) (256-bit number)
       * Relevant for enveloped/EIP1559 transactions only, tx_mode=Enveloped, (disregarded for legacy)
    ...
    throw new NullPointerException();
      ...
      private com.google.protobuf.ByteString maxFeePerGas_ = com.google.protobuf.ByteString.EMPTY;
      /**
       * <pre>
       * Maxinmum fee (256-bit number)
       * Relevant for enveloped/EIP1559 transactions only, tx_mode=Enveloped, (disregarded for legacy)
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "once\030\002 \001(\014\0223\n\007tx_mode\030\003 \001(\0162\".TW.Ethereu" +
      "m.Proto.TransactionMode\022\021\n\tgas_price\030\004 \001" +
      "(\014\022\021\n\tgas_limit\030\005 \001(\014\022!\n\031max_inclusion_f" +
      "ee_per_gas\030\006 \001(\014\022\027\n\017max_fee_per_gas\030\007 \001(" +
      "\014\022\022\n\nto_address\030\010 \001(\t\022\023\n\013private_key\030\t \001" +
      "(\014\0223\n\013transaction\030\n \001(\0132\036.TW.Ethereum.Pr" +
      "oto.Transaction\"O\n\rSigningOutput\022\017\n\007enco" +
      "ded\030\001 \001(\014\022\t\n\001v\030\002 \001(\014\022\t\n\001r\030\003 \001(\014\022\t\n\001s\030\004 \001" +
    ...
    internal_static_TW_Ethereum_Proto_SigningInput_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_TW_Ethereum_Proto_SigningInput_descriptor,
        new java.lang.String[] { "ChainId", "Nonce", "TxMode", "GasPrice", "GasLimit", "MaxInclusionFeePerGas", "MaxFeePerGas", "ToAddress", "PrivateKey", "Transaction", });
    internal_static_TW_Ethereum_Proto_SigningOutput_descriptor =
