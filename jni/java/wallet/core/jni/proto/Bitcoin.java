...
public final class Bitcoin {
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 90: {
              ...
              plan_ = input.readMessage(wallet.core.jni.proto.Bitcoin.TransactionPlan.parser(), extensionRegistry);
              if (subBuilder != null) {
            ...
            case 106: {
              ...
              outputOpReturn_ = input.readBytes();
              break;
            }
            default: {
              if (!parseUnknownField(
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (lockTime_ != 0) {
        output.writeUInt32(12, lockTime_);
      }
      if (!outputOpReturn_.isEmpty()) {
        output.writeBytes(13, outputOpReturn_);
      }
      unknownFields.writeTo(output);
    }
    ...
    public int getSerializedSize() {
      ...
      if (lockTime_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(12, lockTime_);
      }
      if (!outputOpReturn_.isEmpty()) {
        size += com.google.protobuf.CodedOutputStream
          .computeBytesSize(13, outputOpReturn_);
      }
      size += unknownFields.getSerializedSize();
      memoizedSize = size;
      return size;
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getLockTime()
          != other.getLockTime()) return false;
      if (!getOutputOpReturn()
          .equals(other.getOutputOpReturn())) return false;
      if (!unknownFields.equals(other.unknownFields)) return false;
      return true;
    }
    ...
    public int hashCode() {
      ...
      hash = (53 * hash) + getLockTime();
      hash = (37 * hash) + OUTPUT_OP_RETURN_FIELD_NUMBER;
      hash = (53 * hash) + getOutputOpReturn().hashCode();
      hash = (29 * hash) + unknownFields.hashCode();
      memoizedHashCode = hash;
      return hash;
    }
    ...
    public static final class Builder extends
      ...
      public wallet.core.jni.proto.Bitcoin.SigningInput buildPartial() {
        ...
        result.lockTime_ = lockTime_;
        result.outputOpReturn_ = outputOpReturn_;
        onBuilt();
        return result;
      }
      ...
      public Builder mergeFrom(wallet.core.jni.proto.Bitcoin.SigningInput other) {
        ...
        if (other.getOutputOpReturn() != com.google.protobuf.ByteString.EMPTY) {
          setOutputOpReturn(other.getOutputOpReturn());
        }
        this.mergeUnknownFields(other.unknownFields);
        onChanged();
        return this;
  ...
  ensurePrivateKeyIsMutable();
      ...
      private wallet.core.jni.proto.Bitcoin.TransactionPlan plan_;
      private com.google.protobuf.SingleFieldBuilderV3<
          wallet.core.jni.proto.Bitcoin.TransactionPlan, wallet.core.jni.proto.Bitcoin.TransactionPlan.Builder, wallet.core.jni.proto.Bitcoin.TransactionPlanOrBuilder> planBuilder_;
      /**
       * <pre>
       * Optional transaction plan
       * </pre>
      ...
      public wallet.core.jni.proto.Bitcoin.TransactionPlanOrBuilder getPlanOrBuilder() {
        if (planBuilder_ != null) {
          ...
          return plan_ == null ?
              wallet.core.jni.proto.Bitcoin.TransactionPlan.getDefaultInstance() : plan_;
        }
      }
      /**
       * <pre>
      ...
      private com.google.protobuf.ByteString outputOpReturn_ = com.google.protobuf.ByteString.EMPTY;
      /**
       * <pre>
       * Optional zero-amount, OP_RETURN output
       * </pre>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (!outputOpReturn_.isEmpty()) {
        output.writeBytes(8, outputOpReturn_);
      }
      unknownFields.writeTo(output);
    }
    ...
    public int getSerializedSize() {
      ...
      if (!outputOpReturn_.isEmpty()) {
        size += com.google.protobuf.CodedOutputStream
          .computeBytesSize(8, outputOpReturn_);
      }
      size += unknownFields.getSerializedSize();
      memoizedSize = size;
      return size;
    ...
    public static final class Builder extends
      ...
      private com.google.protobuf.ByteString branchId_ = com.google.protobuf.ByteString.EMPTY;
      /**
       * <pre>
       * Zcash branch id
       * </pre>
  ...
  static {
    ...
    internal_static_TW_Bitcoin_Proto_SigningInput_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_TW_Bitcoin_Proto_SigningInput_descriptor,
        new java.lang.String[] { "HashType", "Amount", "ByteFee", "ToAddress", "ChangeAddress", "PrivateKey", "Scripts", "Utxo", "UseMaxAmount", "CoinType", "Plan", "LockTime", "OutputOpReturn", });
    internal_static_TW_Bitcoin_Proto_SigningInput_ScriptsEntry_descriptor =
    ...
    internal_static_TW_Bitcoin_Proto_TransactionPlan_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_TW_Bitcoin_Proto_TransactionPlan_descriptor,
        new java.lang.String[] { "Amount", "AvailableAmount", "Fee", "Change", "Utxos", "BranchId", "Error", "OutputOpReturn", });
    internal_static_TW_Bitcoin_Proto_SigningOutput_descriptor =
