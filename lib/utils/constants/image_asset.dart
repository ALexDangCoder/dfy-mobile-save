...
class ImageAssets {
  ...
  static const String bg_manage_loan_package_list =
      '$baseImg/bg_manage_loan.png';
...
//pawn
  ...
  static const String img_verify_now = '$baseImg/img_verify_now.png';
  static const String img_create_now = '$baseImg/img_create_now.png';
  ...
  static const String ic_show = '$baseImg/ic_show.png';
  ...
  static const String ic_qr_code = '$baseImg/ic_qr_code.png';
  ...
  static const String ic_transfer_svf = '$baseImg/ic_transfer_svf.svg';
  ...
  static String getSymbolAsset(String shortName) {
    ...
    for (final TokenInf value in listTokenSupport) {
      if (value.symbol?.toUpperCase() == shortName.toUpperCase()) {
