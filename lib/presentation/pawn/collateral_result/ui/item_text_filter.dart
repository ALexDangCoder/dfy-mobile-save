...
class _ItemTextFilterState extends State<ItemTextFilter> {
  ...
  Widget build(BuildContext context) {
    late bool isCheck;
    late String name;
    isCheck = widget.bloc.listNetworkFilter[widget.index].isCheck;
    name = widget.bloc.listNetworkFilter[widget.index].symbol.toString();
    void check() {
      late bool value;
      if (isCheck) {
        value = false;
      ...
      isCheck = value;
      widget.bloc.listNetworkFilter[widget.index].isCheck = value;
      setState(() {});
    }
