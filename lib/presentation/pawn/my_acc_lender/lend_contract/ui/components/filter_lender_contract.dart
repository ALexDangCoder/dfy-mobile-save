...
class FilterLenderContract extends StatefulWidget {
  const FilterLenderContract({
    Key? key,
    required this.cubit,
  ...
  @override
  _FilterLenderContractState createState() => _FilterLenderContractState();
}

class _FilterLenderContractState extends State<FilterLenderContract> {
