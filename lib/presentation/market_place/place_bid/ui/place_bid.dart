...
class _PlaceBidState extends State<PlaceBid> {
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            spaceH5,
            _cardCurrentBid(
                nftOnAuction.urlToken ?? '', nftOnAuction.tokenSymbol ?? ''),
            spaceH8,
            ...[
              warningAmount(),
              spaceH8,
  ...
  Widget _cardCurrentBid(String url, String nameToken) {
    return CustomForm(
      textValue: (value) {
        if (value.isNotEmpty) {
  ...
  Widget _spaceButton(BuildContext context) => Align(
        ...
        child: ButtonGradient(
          ...
          onPressed: () {
            nftDetailBloc.callWeb3(context, bidValue, MarketType.AUCTION);
          },
          child: Text(
