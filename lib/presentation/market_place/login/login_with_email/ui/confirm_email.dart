          ...
          children: [
            ...
            PinCodeTextField(
              ...
              pinTheme: PinTheme(
                ...
                fieldHeight: 60,
                fieldWidth: 50,
                activeFillColor: Color(0x1AE4AC1A),
                activeColor: Color(0XFFE4AC1A),
                selectedColor:Color(0x1AE4AC1A),
                selectedFillColor: Color(0x1AE4AC1A),
                errorBorderColor: Color(0xFF585782),
                disabledColor: Color(0XFF33324C),
