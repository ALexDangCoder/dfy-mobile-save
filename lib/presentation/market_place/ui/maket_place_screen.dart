...
import 'package:Dfy/presentation/market_place/ui/nft_search.dart';
                          ...
                          SizedBox(
                            ...
                            child: ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                return NFTItemWidget(
                                  name:
                                      cubit.listFakeDataCollateral[index].name,
                                  price:
                            ...
                            child: ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                return NFTItemWidget(
                                  ...
                                  hotAuction: cubit
                                      .listFakeDataHardNFT[index].hotAuction,
                                );
                              },
                            ),
                          ),
    ...
    return GestureDetector(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => const SearchNFT(),
          ),
        );
      },
      child: Container(
