                ...
                children: [
                  ...
                  Column(
                    children: [
                      ...
                      StreamBuilder(
                        stream: bLocCreateSeedPhrase.isSeedPhraseImportFailed,
            ...
            child: GestureDetector(
              onTap: () {
                if (bLocCreateSeedPhrase.isCheckBox2.value &&
                  ...
                  if (!bLocCreateSeedPhrase.isSeedPhraseImportFailed.value) {
                    ...
                    if (bLocCreateSeedPhrase.isStoreWalletCallback.value) {
